                ...
                c => new
                    {
                        ...
                        IdotartamHonap = c.Int(nullable: false),
                    })
                .PrimaryKey(t => t.Id);
                ...
                c => new
                    {
                        Id = c.Int(nullable: false, identity: true),
                        Nev = c.String(),
                        HirlevelFeliratkozas = c.Boolean(nullable: false),
                        ElofizetesTipus_Id = c.Int(),
                    })
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.ElofizetesTipus", t => t.ElofizetesTipus_Id)
                .Index(t => t.ElofizetesTipus_Id);
